...
SimpleObject3D::SimpleObject3D(QVector<VertexData> vertData, QVector<GLuint> indexes)
    : m_vertexBuffer(QOpenGLBuffer::VertexBuffer),
      m_indexBuffer(QOpenGLBuffer::IndexBuffer) {
  m_texture = nullptr;
...
void SimpleObject3D::init(QVector<VertexData> vertData, QVector<GLuint> indexes) {
  free();
